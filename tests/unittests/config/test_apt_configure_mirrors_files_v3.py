...
""" test_apt_custom_mirrors_files
Test creation of mirrors files
"""
import logging
import os
import shutil
...
class TestAptSourceConfigMirrorsFiles(t_help.FilesystemMockingTestCase):
    """TestAptSourceConfigMirrorsFiles - Class to test mirrors files rendering"""
    ...
    def test_apt_v3_mirrors_list(self):
        ...
        cfg = {"apt": {"enable_mirrors_files": True}}
        ...
        mock_writefile.assert_has_calls([
            call('/etc/apt/mirrors/ubuntu.list', 'http://archive.ubuntu.com/ubuntu/\n', mode=0o644),
            call('/etc/apt/mirrors/ubuntu-security.list', 'http://security.ubuntu.com/ubuntu/\n', mode=0o644),
        ])
